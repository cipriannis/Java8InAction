...
public class GroupingTransactions {
    ...
    private static void groupImperatively() {
        ...
        for(Transaction transaction : transactions){
            ...
            if(!transactionsByCurrency.containsKey(currency)){
                ArrayList<Transaction> transactionsForCurrency = new ArrayList<>();
                ...
                if(!transactionsForCurrency.contains(transaction)){
                    transactionsForCurrency.add(transaction);
                }
            }
        }
